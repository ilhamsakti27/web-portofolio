...
export const userData = {
  name: "ilham muhammad sakti",
  jobs: ["software engineer", "iot engineer"],
  description: "I am a software engineer with experience in programming, web & mobile development, databases, IoT, and AI.",
  socialLinks: {
    linkedin: "https://www.linkedin.com/in/ilham-muhammad-sakti",
    github: "https://github.com/ilhamsakti27",
    instagram: "https://www.instagram.com/ilham__gallery/",
  ...
  projects: [
    {
      id: 1,
      imageURL: "https://raw.githubusercontent.com/ilhamsakti27/Real-time-Collaborative-Editor-Docs-Editor/main/images/Picture7.png",
      nameProject: "Real-time Collaborative Editor (Docs-Editor)",
      company: "Era Real Estate Indonesia",
      description: "A block-based editor that allows users to create, organize, and share different types of content in a flexible environment, including note-taking, documents, to-do lists, and more also designed to support real-time collaboration between users and has a versioning feature for documentation. In this project, I was responsible as a Front-End Dev, designing the UI using Figma and after that creating UI components using JavaScript, Vue.js, Tiptap, and Hocuspocus",
      date: "2023-12-10T00:00:00.000Z",
      techStack: ["Vue.js", "Tiptap", "Hocuspocus", "Figma"],
      typeProject: ["Front-End Dev"],
      linkDocumentation: {
        drive: "",
        github: "https://github.com/ilhamsakti27/Real-time-Collaborative-Editor-Docs-Editor.git",
        instagram: "",
        deploy: "https://docs-editor.vercel.app"
      }
    },
    {
      id: 2,
      imageURL: "https://raw.githubusercontent.com/ilhamsakti27/SenjaKU-mobile-apps/refs/heads/main/images/logo_senjaKU.png?token=GHSAT0AAAAAACOXGHGOJEXYMV2I2UGCYUZEZXQCJOA",
      nameProject: "SenjaKu Mobile Apps",
      company: "My Digital Academy Bank Mandiri Batch 2",
      description: "Collaborated designing a user-friendly digital banking application specifically for elderly people. The app UI is designed using Figma and the app development uses Outsystems' Low-Code platform",
      date: "2024-01-20T00:00:00.000Z",
      techStack: ["Outsystems' Low-Code", "Figma"],
      typeProject: ["Mobile Apps"],
      linkDocumentation: {
        drive: "",
        github: "https://github.com/ilhamsakti27/SenjaKU-mobile-apps.git",
        instagram: "",
        deploy: ""
      }
    },
    {
      id: 3,
      imageURL: "https://camo.githubusercontent.com/18905a643caf64bdd1cda55509b01d2b04daa289bd9dbd10890368d8f4bebc9a/68747470733a2f2f692e706f7374696d672e63632f4e306638713131682f6c6f676f2d776974682d746578742d6c616e6473636170652e706e67",
      nameProject: "AgroHealth",
      company: "Bangkit Academy 2023",
      description: "AgroHealth is a state-of-the-art app designed to assist farmers in detecting diseases effectively. As a Back-End Dev using Node.js, Express.js, Python, Firebase, Cloud Storage, and Compute Engine GCP to create application",
      date: "2023-07-20T00:00:00.000Z",
      techStack: ["Node.js", "Express.js", "Python", "Firebase", "Cloud Storage GCP", "Compute Engine GCP"],
      typeProject: ["Mobile Apps", "Back-End Dev"],
      linkDocumentation: {
        drive: "",
        github: "https://github.com/ilhamsakti27/AgroHealth.git",
        instagram: "",
        deploy: ""
      }
    },
    {
      ...
      linkDocumentation: {
        drive: "",
        github: "https://github.com/ilhamsakti27/Organization-Data-Job-Description-Automation.git",
        instagram: "",
        deploy: ""
      }
    },
    ...
    },
    {
      ...
      linkDocumentation: {
        ...
        instagram: "",
        youtube: "https://www.youtube.com/watch?v=7smPYnFAhEk",
        deploy: ""
      },
    },
    {
      id: 7,
      imageURL: "https://raw.githubusercontent.com/ilhamsakti27/Smart-Home-Assistant/refs/heads/main/Smart%20Home%20Assistant%20Schema.png",
      nameProject: "Smart Home Assistant",
      company: "",
    ...
    {
      id: 8,
      imageURL: "https://res.cloudinary.com/dichfrs7a/image/upload/v1727074593/usah3xylx6dbwkqcugnf.png",
      nameProject: "Design and Implementation of An Automatic Nutrition and Disease Detection System for Hydroponic Spinach Plants Using Raspberry Pi",
      company: "",
